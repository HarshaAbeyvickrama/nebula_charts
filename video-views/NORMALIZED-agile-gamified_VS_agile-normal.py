...
# Normalized y1
y1_normalized = [view_count / (total_agile_gamified_videos * gamified) for view_count in y1]

# Data for Dataset 2
y2 = [1, 0, 2, 0, 0, 3, 0, 1, 1, 2, 0, 1, 2, 3, 0, 2, 6, 0, 20, 0, 0, 0, 0, 0, 0, 0, 1, 24, 0]  # Y-axis data
# Normalized y2
y2_normalized = [view_count / (total_agile_non_gamified_videos * non_gamified) for view_count in y2]
...
ax1.set_title('Normalized views comparison between APM_G and APM_NG')
